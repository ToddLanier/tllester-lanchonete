...
\-       Artist residencies that enable international artists to be a part of public events and those convened by KUIR City, e.g. Mix Brasil Festival—Carlos Motta (Colombia), Maya Mikdashi (Lebanon), Niki Singleton (Canada), Thea Little (US)—and _In Between_, a conference on public policies for transitory spaces for which Jean-Francois Prost (Canada) was a speaker within a broader three-week research residency in the Center of São Paulo;
